                    ...
                    <?php
                        ...
                        if ($result && $result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                echo "<th scope='row'>" . htmlspecialchars($row['ma_bviet']) . "</th>";
                                echo "<td>" . htmlspecialchars($row['tieude']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['ten_bhat']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['ten_the_loai']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['ten_tac_gia']) . "</td>";
                                echo "<td><a href='edit_article.php?id=" . htmlspecialchars($row['ma_bviet']) . "'><i class='fa-solid fa-pen-to-square'></i></a></td>";
                                echo "<td><a href='del_article.php?id="  . htmlspecialchars($row['ma_bviet']) . "' onclick=\"return confirm('Bạn có chắc chắn muốn xóa không?');\"><i class='fa-solid fa-trash'></i></a></td>";
                                echo "</tr>";
                            }
                        } else {
