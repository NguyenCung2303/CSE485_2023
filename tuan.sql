...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 17, 2024 lúc 09:48 AM
...
INSERT INTO `bai_viet` (`ma_bviet`, `tieude`, `ten_bhat`, `tomtat`, `noidung`, `ngayviet`, `hinhanh`, `ma_tloai`, `ma_tgia`) VALUES
...
(2, 'Cảm ơn em đã rời xa anh', 'Vết mưa', 'Cảm ơn em đã cho anh những tháng ngày hạnh phúc, cho anh biết yêu và được yêu. Em cho anh được nếm trải hương vị ngọt ngào của tình yêu nhưng cũng đầy đau khổ và nước mắt. Những tháng ngày đó có lẽ suốt cuộc đời anh không bao giờ quên', NULL, '2012-02-12 00:00:00', NULL, 2, 3),
(3, 'Cuộc đời có mấy ngày mai?', 'Phôi pha', 'Đêm nay, trời quang mây tạnh, trong người nghe hoang vắng và tôi ngồi đây “Ôm lòng đêm, Nhìn vầng trăng mới về” mà ngậm ngùi “Nhớ chân giang hồ. Ôi phù du, từng tuổi xuân đã già”', NULL, '2014-03-13 00:00:00', NULL, 2, 4),
...
(6, 'Hard Rock Hallelujah', 'Hard Rock Hallelujah', 'Những linh hồn đang lạc lối, mù quáng mất phương hướng trong cõi trần gian đầy nghiệt ngã hãy nên lắng nghe \"Hard Rock Hallelujah\" để có thể quên tất cả mọi thứ để tìm về đúng bản chất sâu thẳm nhất trong tâm hồn chính mình!', NULL, '2013-09-12 00:00:00', NULL, 7, 6),
...
(8, 'Nơi tình yêu bắt đầu', 'Nơi tình yêu bắt đầu', 'Nhiều người sẽ nghĩ làm gì có yêu nhất và làm gì có yêu mãi. Ừ! Chẳng có gì là mãi mãi cả, vì chúng ta không trường tồn vĩnh cửu', NULL, '2014-02-03 00:00:00', NULL, 1, 1),
...
(10, 'I\'m stronger', 'I\'m stronger', 'Em không phải là người giỏi giấu cảm xúc, nhưng em lại là người giỏi đoán biết cảm xúc của người khác vậy nên đừng cố nói nhớ em, rằng mọi thứ chỉ là do hoàn cảnh. Và cũng đừng dối em rằng anh đã từng yêu em. Em nhắm mắt cũng cảm nhận được mà, thật đấy', NULL, '2013-08-21 00:00:00', NULL, 7, 2),
...
INSERT INTO `tac_gia` (`ma_tgia`, `ten_tgia`, `hinh_tgia`) VALUES
(1, 'Nhacvietplus', ''),
(2, 'Sưu tầm', ''),
(3, 'Sandy', ''),
(4, 'Lê Trung Ngân', ''),
...
INSERT INTO `the_loai` (`ma_tloai`, `ten_tloai`) VALUES
(1, 'Nhạc trẻ'),
(2, 'Nhạc trữ tình'),
(3, 'Nhạc cách mạng'),
(4, 'Nhạc thiếu nhi'),
